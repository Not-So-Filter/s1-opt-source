...
Obj09_Jump:
		...
		bset	#1,obStatus(a0)
		moveq	#sfx_Jump,d0
		jmp	(PlaySound).w	; play jumping sound
...
Obj09_NoEmer:
		...
		jsr	(PlayMusic).w ;	play emerald music
		moveq	#0,d4
		rts
; ===========================================================================
...
Obj09_BumpSnd:
		moveq	#sfx_Bumper,d0
		jmp	(PlaySound).w	; play bumper sound
; ===========================================================================
...
Obj09_GOAL:
		...
		moveq	#sfx_SSGoal,d0
		jmp	(PlaySound).w	; play "GOAL" sound
; ===========================================================================
...
Obj09_UPsnd:
		moveq	#sfx_SSItem,d0
		jmp	(PlaySound).w	; play up/down sound
; ===========================================================================
...
Obj09_GlassSnd:
		...
		jmp	(PlaySound).w	; play glass block sound
; ===========================================================================
