...
TempoWait:
	...
	ld	hl,zAbsVar.TempoTimeout		; Adds previous value to
...
zPSGFrequencies:
	...
	dw 1Bh,1Ah,18h,17h,16h,15h,13h,12h,11h,10h,0h,0h
; ---------------------------------------------------------------------------
...
zPlaySoundByIndex:
	...
	cp	sfx__First			; is it not a sound effect? (this check is redundant if MusID__End == SndID__First...)
...
.loop:
	...
	ld	b,pcmLoopCounter(14500,86)	; 7	; Sega PCM pitch
	djnz	$				; 8	; Delay loop
	...
	ld	a,d				; 4	; a = d
	or	e				; 4	; Is de zero?
	jr	nz,.loop			; 7	; If not, loop
						; 86
	; One sample per 86 cycles, meaning that the second parameter
...
dac_sample_metadata macro label,sampleRate
	...
	dac_sample_metadata zDACPtr_Kick,    8000	; 83h
	dac_sample_metadata zDACPtr_Kick,    8000	; 84h
	dac_sample_metadata zDACPtr_Kick,    8000	; 85h
	dac_sample_metadata zDACPtr_Kick,    8000	; 86h
	dac_sample_metadata zDACPtr_Kick,    8000	; 87h
